...
new TypeIt("#type1", {
  ...
  .type("Assistant Professor | Ph.D Scholar | Web Developer")
  // .pause(500)
  // .delete(9)
  // .type("Professor", { delay: 400 })
  // .pause(500)
  // .delete(9)
  .go();
...
new TypeIt("#type2", {
  ...
  .type("Assistant Professor", { delay: 400 })
  // .pause(500)
  // .delete(9)
  .type(" & Ph.D Scholar", { delay: 400 })
  .pause(500)
  // .delete(9)
  .go();
